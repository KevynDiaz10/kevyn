        ...
        <div className="-my-6">
          {dataAboutPage.map((data) => (
            <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
              <h3 className="mt-1 text-2xl font-bold sm:mb-0">{data.title}</h3>
              <div
              ...
              >
                <time className="sm:absolute left-0 translate-x-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-full">

                  {data.date}
                </time>
                <p className="text-xl font-bold text-indigo-600">{data.subtitle}</p>
              </div>
